...
class OrdersListViewTestCase(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.order_user = "".join(choices(ascii_letters, k=10))
        Product.objects.filter(name=self.product_name).delete()
...
class OrderDetailsViewTestCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.user.user_permissions.add(
            Permission.objects.get(codename='view_order', content_type__app_label='shopapp')
        )
    ...
    def test_order_details(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn(self.order_data['delivery_address'], response.content.decode())
        self.assertIn(self.order_data['promocode'], response.content.decode())
